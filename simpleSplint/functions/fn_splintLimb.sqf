...
private _splint_time = missionNamespace getVariable ["simpleSplint_time",20];
...
[_splint_time, [_hitPoint, _selectionNumbers, _player, _target], simpleSplint_fnc_fixLimb, _onInterrupt, "Applying SAM Splint", {true}, ["isNotInside", "isNotSwimming"]] call ace_common_fnc_progressBar;
