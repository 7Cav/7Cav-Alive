...
// ACE Nightvision
//ace_nightvision_aimDownSightsBlur = 0.25;
...
force force cScripts_Settings_enforceEyewereBlacklist = false;
force force cScripts_Settings_jumpSimulation = 0;
...
force force cScripts_Settings_setCustomHintText = "Public Mission!";
force force cScripts_Settings_setCustomHintTopic = "This is Tactical Realism. Be tactical and realistic.";
force force cScripts_Settings_setMissionType = 3;
force force cScripts_Settings_setPlayerRank = true;
force force cScripts_Settings_setRedLightTime = 30;
