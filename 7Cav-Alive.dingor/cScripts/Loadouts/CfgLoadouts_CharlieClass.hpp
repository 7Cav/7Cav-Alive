...
class Cav_B_C_PlatoonLeader_Misfit_6_F : Cav_B_C_PlatoonStaff_F {};
class Cav_B_C_PlatoonSergeant_Misfit_5_F : Cav_B_C_PlatoonStaff_F {};
...
class Cav_B_C_Bravo_RiflemanLAT_F : Cav_B_C_Rifleman_F {};
