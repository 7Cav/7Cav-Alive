...
private _public_alive_body      = format["<t font='PuristaMedium' size='1'>Welcome, <t color='#ffc61a'>%1</t>, to the 7th Cavalry Tactical Realism 2 server! You are currently slotted in as <t color='#ffc61a'>%2 %3</t>.<br /><br /><br /><t font='PuristaMedium' size='1.2' color='#FF0000'>For Questions about the mission file, read the information located on the left side of the map screen under How-To-Alive</t><br /><br /><t font='PuristaMedium' size='1.2' color='#01aae1'>Teamspeak Info</t><br /><t font='PuristaMedium' size='1'>Name: ts3.7cav.us<br />Password: 7thCavalry</t>", _player_name, _player_role, _player_group];
